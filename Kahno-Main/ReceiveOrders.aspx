<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ReceiveOrders.aspx.cs" Inherits="Kahno_Main.RecieveOrders" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="floatingdiv" style="width:80%; left:10%; align-content:center">
        <h1>Orders Today</h1>
        <p style="color:gray;">Refreshes every 30 seconds</p>
